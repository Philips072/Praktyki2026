const LESSONS = [
  {
    ...
    exercises: [
      ...
      { id: 3, task: 'Utwórz tabelę gracze z kolumnami: id (INTEGER, PRIMARY KEY, AUTO_INCREMENT), imie (VARCHAR(100), NOT NULL), nazwisko (VARCHAR(100), NOT NULL).', placeholder: '', hint: 'Użyj składni: id INTEGER PRIMARY KEY AUTO_INCREMENT, imie VARCHAR(100) NOT NULL...', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 4, task: 'Utwórz tabelę mecze z kolumnami: id (INTEGER, PRIMARY KEY, AUTO_INCREMENT), data (DATE), wynik (VARCHAR(50)).', placeholder: '', hint: 'Pamiętaj o typie DATE dla kolumny data.', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 5, task: 'Utwórz tabelę statystyki z kolumnami: id (INTEGER, PRIMARY KEY), gracz_id (INTEGER), bramki (INTEGER, DEFAULT 0), asysty (INTEGER, DEFAULT 0).', placeholder: '', hint: 'Użyj DEFAULT 0 po typie kolumny, np. bramki INTEGER DEFAULT 0', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 6, task: 'Wyświetl strukturę tabeli gracze (nazwy kolumn, typy i ograniczenia).', placeholder: '', hint: 'Użyj: DESCRIBE gracze; lub DESC gracze;', expectedColumns: [], expectedRows: [], validateOnly: true },
      ...
      { id: 8, task: 'Usuń tabelę statystyki z bazy danych.', placeholder: '', hint: 'Użyj: DROP TABLE nazwa_tabeli;', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 9, task: 'Usuń bazę danych liga_pilkarska.', placeholder: '', hint: 'Użyj: DROP DATABASE nazwa_bazy;', expectedColumns: [], expectedRows: [], validateOnly: true },
    ],
  },
  {
    id: 2,
    ...
    theory: {
      ...
      schema: [
        ...
        { name: 'pozycja', type: 'TEXT', desc: 'Pozycja na boisku (opcjonalna)' },
      ],
    },
    exercises: [
      { id: 1, task: 'Dodaj kolumnę wiek (INTEGER) do tabeli gracze.', placeholder: '', hint: 'Składnia: ALTER TABLE gracze ADD COLUMN wiek INTEGER', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 2, task: 'Dodaj kolumnę aktywny (BOOLEAN) z domyślną wartością TRUE do tabeli gracze.', placeholder: '', hint: 'Dodaj DEFAULT TRUE na końcu definicji kolumny.', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 3, task: 'Zmień nazwę kolumny wiek na lata w tabeli gracze.', placeholder: '', hint: 'Użyj CHANGE COLUMN: ALTER TABLE gracze CHANGE COLUMN wiek lata INTEGER', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 4, task: 'Usuń kolumnę lata z tabeli gracze.', placeholder: '', hint: 'Składnia: ALTER TABLE gracze DROP COLUMN lata', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 5, task: 'Zmień typ kolumny aktywny na INTEGER w tabeli gracze.', placeholder: '', hint: 'Użyj MODIFY COLUMN: ALTER TABLE gracze MODIFY COLUMN aktywny INTEGER', expectedColumns: [], expectedRows: [], validateOnly: true },
      { id: 6, task: 'Zmień nazwę tabeli gracze na zawodnicy.', placeholder: '', hint: 'Składnia: ALTER TABLE gracze RENAME TO zawodnicy', expectedColumns: [], expectedRows: [], validateOnly: true },
    ],
  },
  {
    id: 3,
